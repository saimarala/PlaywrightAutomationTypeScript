...
//  grepInvert:/@regression/, //specify tag by sai
 ...
 // timeout: 6000,
  ...
  //To apply a longer wait for all expect conditions (default is 5000 ms/5 secs) - sai
 ...
 // reporter: 'html',
 // reporter:'list'
 // reporter:[['html',{open:'always'}]],// done by sai
  reporter:[['html',{open:'always','outputFolder':'html-report'}],
            ['list'],
            ['line'],
            ['dot'],
            ['junit',{outputFile:'result.xml'}],
            ['json',{outputFile:'result.xml'}],
            ['allure-playwright']
                 ],// custom path done by sai
  ...
  use: {
   ...
   // viewport: { width: 1280, height: 720 },
    ...
    testIdAttribute:'dat-pw'// configured data-testid
  },
